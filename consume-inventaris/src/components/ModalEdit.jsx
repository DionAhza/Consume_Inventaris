                            ...
                            <div className="mb-6">
                                {item.tag === "select" ? (
                                    <>
                                        ...
                                        <select id="category" name={index} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm
                                    ...
                                    <>
                                        ...
                                        <input type={item.type} name={index} id="name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm
